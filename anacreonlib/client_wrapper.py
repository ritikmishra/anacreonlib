...
@dataclass
class StatefulMethodDetails:
    request_type: Type[SerializableDataclass]
    api_request_type: Type[AnacreonApiRequest]
...
class MilitaryForceInfo(NamedTuple):
    space_forces: float
    ground_forces: float
...
class AnacreonClientWrapper:
    ...
    async def get_objects(self) -> "AnacreonClientWrapper":
        """
